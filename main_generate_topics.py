...
def create_arguments():
    ...
    parser.add_argument('--stem', dest='stem', action='store_true', default=False,
                        help='If applied apart from stopwords the vocabulary will be stemmed before generating topics')
